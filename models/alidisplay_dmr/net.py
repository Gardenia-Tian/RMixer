...
class DMRLayer(nn.Layer):
    def __init__(self, user_size, cms_segid_size, cms_group_id_size,
        ...
        self.query_prelu = paddle.nn.PReLU(
            num_parameters=self.history_length, init=0.1
            # , name='dm_prelu'
            )
        self.att_layer1_layer = paddle.nn.Linear(
            self.main_embedding_size * 8, 80
            # , name='dm_att_1'
            )
        self.att_layer2_layer = paddle.nn.Linear(80, 40
        # , name='dm_att_2'
        )
        self.att_layer3_layer = paddle.nn.Linear(40, 1
        # , name='dm_att_3'
        )
        ...
        self.att_layer2_layer2 = paddle.nn.Linear(80, 40
        # , name='tg_att_2'
        )
        self.att_layer3_layer2 = paddle.nn.Linear(40, 1
        # , name='tg_att_3'
        )
        ...
        self.dnn0_layer = paddle.nn.Linear(self.inp_length, 512
        # , name='f0'
        )
        self.dnn0_prelu = paddle.nn.PReLU(
            num_parameters=512, init=0.1
            # , name='prelu0'
            )
        self.dnn1_layer = paddle.nn.Linear(512, 256
        # , name='f1'
        )
        self.dnn1_prelu = paddle.nn.PReLU(
            num_parameters=256, init=0.1
            # , name='prelu1'
            )
        self.dnn2_layer = paddle.nn.Linear(256, 128
        # , name='f2'
        )
        self.dnn2_prelu = paddle.nn.PReLU(
            num_parameters=128, init=0.1
            # , name='prelu2'
            )
        self.dnn3_layer = paddle.nn.Linear(128, 1
        # , name='f3'
        )
        self.dnn3_prelu = paddle.nn.PReLU(
            num_parameters=1, init=0.1
            # , name='prelu3'
            )
